...
export default function Hero() {
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <motion.div animate={{ y: [-10, 10, -10], rotate: [0, 5, 0] }} transition={{ duration: 6, repeat: Infinity }}
        className="absolute top-32 right-20 hidden lg:block">
        <div className="p-3 rounded-2xl glass"><Zap size={24} className="text-amber" /></div>
      </motion.div>
      <motion.div animate={{ y: [10, -10, 10], rotate: [0, -5, 0] }} transition={{ duration: 7, repeat: Infinity }}
        className="absolute bottom-40 left-20 hidden lg:block">
        <div className="p-3 rounded-2xl glass"><Shield size={24} className="text-emerald" /></div>
      </motion.div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-24 sm:py-28 w-full relative z-10">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] mb-6" style={{ color: "var(--text-primary)" }}>
              <span className="gradient-text">Abdul</span>
              <br />
              <span className="gradient-text">Moeez</span>
            </h1>

            <h2 className="text-base sm:text-lg md:text-xl font-medium mb-6" style={{ color: "var(--text-secondary)" }}>
              Cloud Infrastructure &amp; DevOps Engineer
            </h2>

            <p className="text-sm sm:text-base leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0" style={{ color: "var(--text-muted)" }}>
              I turn infrastructure chaos into{" "}
              <span className="text-primary font-semibold">reliable, self-healing systems</span> — cutting
              deployment times from hours to minutes, eliminating downtime, and building{" "}
              <span className="text-accent font-semibold">cloud architectures that scale under pressure</span>{" "}
              without burning your budget.
            </p>

            <div className="flex flex-wrap justify-center md:justify-start gap-3 mb-8">
              <a href="#contact"
                className="group px-6 py-3 rounded-xl bg-gradient-to-r from-primary to-accent text-white font-semibold shadow-lg shadow-primary/25 hover:shadow-primary/40 hover:scale-105 transition-all duration-300 flex items-center gap-2">
                <Sparkles size={16} className="group-hover:rotate-12 transition-transform" />
                Let&apos;s Build Together
              </a>
              <a href={`${basePath}/resume.pdf`} download="Abdul_Moeez_Resume.pdf"
                className="px-6 py-3 rounded-xl font-semibold flex items-center gap-2 transition-all duration-300 hover:scale-105 gradient-border"
            ...
            <div className="flex flex-wrap justify-center md:justify-start items-center gap-3">
              ...
              <a href="https://www.linkedin.com/in/abdul-moeez-64760529b/" target="_blank"
                className="p-2.5 rounded-xl transition-all duration-300 hover:scale-110" style={{ background: "var(--bg-tertiary)" }}>
              ...
              <a href="mailto:moeez7978911@email.com"
                className="p-2.5 rounded-xl transition-all duration-300 hover:scale-110" style={{ background: "var(--bg-tertiary)" }}>
                <Mail size={18} style={{ color: "var(--text-secondary)" }} />
              </a>
              <a href="https://wa.me/923227978911"
                className="p-2.5 rounded-xl transition-all duration-300 hover:scale-110" style={{ background: "var(--bg-tertiary)" }}>
          ...
          {/* Profile visual — hidden on mobile */}
          <motion.div
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
          ...
          >
            ...
            <motion.div animate={{ y: [-5, 5, -5] }} transition={{ duration: 4, repeat: Infinity }}
              className="absolute -right-4 top-1/4 card px-4 py-3 rounded-xl">
            ...
            <motion.div animate={{ y: [5, -5, 5] }} transition={{ duration: 5, repeat: Infinity }}
              className="absolute -left-4 bottom-1/4 card px-4 py-3 rounded-xl">
