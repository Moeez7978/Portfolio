      ...
      <div className="max-w-7xl mx-auto px-6 py-32 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://linkedin.com/in/abdulmoeez" target="_blank" className="p-2.5 rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg" style={{ background: "var(--bg-tertiary)" }}>
            ...
            <a href="mailto:abdulmoeez@email.com" className="p-2.5 rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg" style={{ background: "var(--bg-tertiary)" }}>
              <Mail size={18} style={{ color: "var(--text-secondary)" }} />
            </a>
            <a href="tel:+923227978911" className="p-2.5 rounded-xl transition-all duration-300 hover:scale-110 hover:shadow-lg" style={{ background: "var(--bg-tertiary)" }}>
