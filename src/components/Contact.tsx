      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="max-w-xl mx-auto text-base" style={{ color: "var(--text-muted)" }}>
            Ready to bring your cloud infrastructure to the next level? I help businesses
            ship faster, scale smarter, and reduce costs. Let&apos;s talk.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          >
            ...
            <div className="card p-6 rounded-2xl relative overflow-hidden">
              ...
              <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
                Whether you need cloud architecture, CI/CD pipelines, or a full-stack application —
                I&apos;m here to deliver results.
              </p>
            </div>

            <div className="card p-5 rounded-xl flex items-center gap-4 group">
            ...
            <div className="card p-5 rounded-xl flex items-center gap-4 group">
              <div className="p-3 rounded-xl bg-gradient-to-br from-emerald to-emerald">
            ...
            <div className="card p-5 rounded-xl flex items-center gap-4 group">
              <div className="p-3 rounded-xl bg-gradient-to-br from-amber to-amber">
          ...
          <motion.form
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="lg:col-span-3 card p-8 rounded-2xl space-y-5"
